...
namespace LaBoiteAChaussures.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        private static readonly List<Type> KnownTypes2 = new List<Type>();
        private static Dictionary<string, object> sessionState = new Dictionary<string, object>();
        
        /// <summary>
        /// Gets: Provides access to global session state for the current session.  This state is
        ...
        /// <summary>
        /// Gets: List of custom types provided to the <see cref="DataContractSerializer"/> when
        /// reading and writing session state.  Initially empty, additional types may be
        /// added to customize the serialization process.
        /// </summary>
        public static List<Type> KnownTypes
        {
            get { return KnownTypes2; }
        }
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                DataContractSerializer serializer = new DataContractSerializer(typeof(Dictionary<string, object>), KnownTypes2);
        ...
        public static async Task RestoreAsync(string sessionBaseKey = null)
        {
            ...
            try
            {
                ...
                using (IInputStream inStream = await file.OpenSequentialReadAsync())
                {
                    ...
                    var serializer = new DataContractSerializer(typeof(Dictionary<string, object>), KnownTypes2);
